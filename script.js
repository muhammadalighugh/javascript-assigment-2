document.getElementById("Concatenate").onclick=function(){
    ...
    let num2 = "70"
    let sum = num1 + num2 ;
    document.getElementById("Statement").innerHTML='"90" + "70" '
 ...
 document.getElementById("ifnested").onclick=function(){
     ...
     if(userName==="muhammadalighugh"){
         ...
         document.getElementById("output").innerHTML="Wrong userNAme <br> Correct user name is MSOW BY SHAHZAIB"
     }
 }
 ...
 document.getElementById("login").onclick = function(){
     ...
     if(Username ==="muhammadalighugh"){
         if(Password==="123456"){
             ...
             document.getElementById("output").innerHTML="incorrect password or username <br>MSOW BY SHAHZAIB use  as username or 804805 as password "
         }
     }
     else{
